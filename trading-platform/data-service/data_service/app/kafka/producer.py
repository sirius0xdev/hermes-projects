...
from data_service.app.kafka.config import TOPIC_CONFIG, get_topic_config
...
class DataProducer:
    ...
    def send_price(self, event: Any) -> None:
    ...
    def send_orderbook(self, event: Any) -> None:
    ...
    def send_trade(self, event: Any) -> None:
    ...
    def send_news_article(self, article: Any) -> None:
    ...
    def send_news_analysis(self, analysis: Any) -> None:
    ...
    def send_trading_signal(self, signal: Any) -> None:
